...
## Original photographs underlying Figure 1

Original photographic files underlying panels A, B, D, and E of Figure 1 are provided in:

```text
extras/Figure_1/original_images/
```

All photographs were taken by Diego Fernando García Castillo specifically for this study.

### Figure 1A–B: *Atta* soldiers

The original photographs underlying the ant panels are:

- `Fig1A_Atta_cephalotes_lateral_original.jpeg` — original lateral-view photograph of an *Atta cephalotes* soldier.
- `Fig1A_Atta_cephalotes_head_original.jpeg` — original head-view photograph of an *A. cephalotes* soldier.
- `Fig1B_Atta_laevigata_lateral_original.jpeg` — original lateral-view photograph of an *Atta laevigata* soldier.
- `Fig1B_Atta_laevigata_head_original.jpeg` — original head-view photograph of an *A. laevigata* soldier.

The ants were photographed on millimeter-grid paper. The versions used in the current manuscript figure were generated by cropping the original photographs for composition; no other image processing was applied.

### Figure 1D–E: hemispherical photographs

The photographs underlying the representative canopy-openness panels are:

- `Fig1D_Atta_cephalotes_mean_canopy_openness.jpg` — photograph used for Figure 1D (*A. cephalotes*); corresponds to `IMG_20260222_092308.jpg` in the Zenodo hemispherical-photographs dataset.
- `Fig1E_Atta_laevigata_mean_canopy_openness.jpg` — photograph used for Figure 1E (*A. laevigata*); corresponds to `IMG_20260208_124517.jpg` in the Zenodo hemispherical-photographs dataset.

These two files are copies of original field photographs archived in the complete hemispherical-photograph dataset:

**Zenodo:** https://doi.org/10.5281/zenodo.20344008

This directory documents the provenance of the photographic material used to construct Figure 1 and facilitates direct comparison with the original source images.
...
Large datasets, including the original hemispherical photographs and ERA5-Land GRIB files used in the analyses, are permanently archived in Zenodo at the links provided above. Original photographic files underlying Figure 1A–B, together with copies of the Figure 1D–E hemispherical photographs for direct provenance tracking, are provided in `extras/Figure_1/original_images/`.

## Citation

If you use the data or analysis workflow provided in this repository, please cite the associated preprint:

> García Castillo DF. Generalism vs. specialization: Does niche breadth influence species responses to anthropogenic land-use change in Neotropical leaf-cutter ants? bioRxiv. 2026. https://doi.org/10.64898/2026.08.12.744409

The citation will be updated with the final peer-reviewed publication once available.
